...
def test_right_way(browser):
    ...
    # WebDriverWait(browser, timeout=20, poll_frequency=1).until(   # Я удалил эту строчку и все заработало
    #   EC.url_to_be("https://test.qa.studio/?page_id=10"))         # Я удалил эту строчку и все заработало
